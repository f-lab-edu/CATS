...
from ..inputs import build_input_features, create_embedding_matrix, SparseFeat, DenseFeat, VarLenSparseFeat
...
class BaseModel(nn.Module):
    ...
    def __init__(self, dnn_feature_columns, l2_reg_embedding=1e-5, init_std=0.0001, seed=1024, task='binary',
